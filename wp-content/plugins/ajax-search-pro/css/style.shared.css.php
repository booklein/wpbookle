...
@font-face {
    ...
    src: url('<?php echo str_replace('http:',"",plugins_url()); ?>/ajax-search-pro/css/fonts/icons/icons.eot');
    src: url('<?php echo str_replace('http:',"",plugins_url()); ?>/ajax-search-pro/css/fonts/icons/icons.eot?#iefix') format('embedded-opentype'), url('<?php echo str_replace('http:',"",plugins_url()); ?>/ajax-search-pro/css/fonts/icons/icons.woff') format('woff'), url('<?php echo str_replace('http:',"",plugins_url()); ?>/ajax-search-pro/css/fonts/icons/icons.ttf') format('truetype'), url('<?php echo str_replace('http:',"",plugins_url()); ?>/ajax-search-pro/css/fonts/icons/icons.svg#icons') format('svg');
    font-weight: normal;
    font-style: normal;
}
...
<?php else: ?>
	...
	<?php endif; ?>
<?php endif; ?>
	<?php echo str_replace("--g--", "", w_isset_def( $style['search_text_font'], "") ); ?>
