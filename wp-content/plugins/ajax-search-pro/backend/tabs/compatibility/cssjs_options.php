...
<div class="item">
    <?php $o = new wpdreamsYesNo("load_in_footer", "Load scripts in footer?",
        wpdreams_setval_or_getoption($com_options, 'load_in_footer', 'asp_compatibility_def')
    ); ?>
...
<div class="item">
    <?php $o = new wpdreamsYesNo("css_async_load", "Load CSS files conditionally? (asnychronous, <b>experimental!</b>)",
        wpdreams_setval_or_getoption($com_options, 'css_async_load', 'asp_compatibility_def')
    ); ?>
    <p class='descMsg'>
